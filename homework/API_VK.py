...
# fields 
# can_write_private_message (int) Может ли текущий пользователь отправить личное сообщение 0 - нет, 1-да
# contacts                      Информация о телефонных номерах пользователя
# connections                   Возвращает данные об указанных в профиле сервисах Например, "instagram": "username".
# has_mobile                    Информация о том, известен ли номер мобильного значения: 1 — известен, 0 — не известен
...
# используем count и offset, чтобы получить те же id по count за раз:
count = 1000 
offset = 0 
user_ids = [] 
